...
!function($) {
    ...
    CalendarApp.prototype.onEventClick =  function (calEvent, jsEvent, view) {
        var $this = this;
            ...
            $this.$modal.find('.delete-event').show().end().find('.save-event').hide().end().find('.modals-body').empty().prepend(form).end().find('.delete-event').unbind('click').click(function () {
    ...
    CalendarApp.prototype.onSelect = function (start, end, allDay) {
        var $this = this;
            ...
            $this.$modal.find('.delete-event').hide().end().find('.save-event').show().end().find('.modals-body').empty().prepend(form).end().find('.save-event').unbind('click').click(function () {
                form.submit();
            });
            $this.$modal.find('form').on('submit', function () {
